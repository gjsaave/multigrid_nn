...
mgdrop = None
if alg == "mgdrop":
    mgdrop = MGDrop(total_num_layers, levels, alpha, compute_hessian, clear_grads, store_weights, bls_num_test_points, dataset=dataset, opt_method=opt_method, loss_method=loss_method, model_type=model_type, drop_rate=drop_rate, drop_rate_conv=drop_rate_conv, device=device, vx_term=vx_term)
