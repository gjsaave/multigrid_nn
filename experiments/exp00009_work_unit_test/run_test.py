...
exp_folder = "seed" + str(random_seed) + "_batchsize" + str(batch_size) + "_momentum" + str(momentum) + "_weightdecay" + str(weight_decay)  + "_lr" + str(base_lr) + "_iters" + str(iters) + "_numevals" + str(num_evals) + "_droprate" + str(drop_rate)  + "_modeltype" + str(model_type) + "_numhiddennodes" + str(num_hidden_nodes) + "_valeveryniters" + str(val_every_n_iters)
...
for num_layers in [2,4,6,10]:
    ...
    plt.title("Timing for " + str(num_layers) + " layers")
